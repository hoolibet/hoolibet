...
In order to support loading of multiple wallets in hoolibet-qt, a few changes in the UI architecture will be needed.
...
Only requiring some minor changes is hoolibet.cpp.
...
Changes to hoolibet.cpp
----------------------
hoolibet.cpp is the entry point into hoolibet-qt, and as such, will require some minor modifications to provide hooks for
