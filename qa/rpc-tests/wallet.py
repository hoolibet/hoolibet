...
#   c) node1 mines 32 blocks, so now node 0 has 60001hbet, node 1 has 4250hbet, node2 has none.
#   d) node0 sends 601 hbet to node2, in two transactions (301 hbet, then 300 hbet).
