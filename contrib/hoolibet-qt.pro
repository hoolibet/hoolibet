...
RESOURCES += src/qt/hoolibet.qrc src/qt/hoolibet_locale.qrc

TRANSLATIONS += src/qt/locale/hoolibet_en.ts \
                src/qt/locale/hoolibet_ru.ts
