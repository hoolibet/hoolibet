Contributing to HooliBet Core
============================

The HooliBet Core project operates an open contributor model where anyone is
...
The following applies to code changes to the HooliBet Core project, and is not to be
confused with overall HooliBet Network Protocol consensus changes.

Whether a pull request is merged into HooliBet Core rests with the project merge
...
Patches that change HooliBet consensus rules are considerably more involved than
...
Where a patch set proposes to change the HooliBet consensus, it must have been
...
The project leader is the release manager for each HooliBet Core release.
