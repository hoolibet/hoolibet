...
UniValue stop(const UniValue& params, bool fHelp)
{
    ...
    if (fHelp || params.size() > 1)
        throw runtime_error(
            "stop\n"
            "\nStop HooliBet server.");
    // Event loop will exit after current HTTP requests have been handled, so
    // this reply will get back to the client.
    StartShutdown();
    return "HooliBet server stopping";
}
...
static const CRPCCommand vRPCCommands[] =
    {
        ...
        /* HooliBet features */
        {"hoolibet", "masternode", &masternode, true, true, false},
        {"hoolibet", "listmasternodes", &listmasternodes, true, true, false},
        {"hoolibet", "getmasternodecount", &getmasternodecount, true, true, false},
        {"hoolibet", "masternodeconnect", &masternodeconnect, true, true, false},
        {"hoolibet", "createmasternodebroadcast", &createmasternodebroadcast, true, true, false},
        {"hoolibet", "decodemasternodebroadcast", &decodemasternodebroadcast, true, true, false},
        {"hoolibet", "relaymasternodebroadcast", &relaymasternodebroadcast, true, true, false},
        {"hoolibet", "masternodecurrent", &masternodecurrent, true, true, false},
        {"hoolibet", "masternodedebug", &masternodedebug, true, true, false},
        {"hoolibet", "startmasternode", &startmasternode, true, true, false},
        {"hoolibet", "createmasternodekey", &createmasternodekey, true, true, false},
        {"hoolibet", "getmasternodeoutputs", &getmasternodeoutputs, true, true, false},
        {"hoolibet", "listmasternodeconf", &listmasternodeconf, true, true, false},
        {"hoolibet", "getmasternodestatus", &getmasternodestatus, true, true, false},
        {"hoolibet", "getmasternodewinners", &getmasternodewinners, true, true, false},
        {"hoolibet", "getmasternodescores", &getmasternodescores, true, true, false},
        {"hoolibet", "mnbudget", &mnbudget, true, true, false},
        {"hoolibet", "preparebudget", &preparebudget, true, true, false},
        {"hoolibet", "submitbudget", &submitbudget, true, true, false},
        {"hoolibet", "mnbudgetvote", &mnbudgetvote, true, true, false},
        {"hoolibet", "getbudgetvotes", &getbudgetvotes, true, true, false},
        {"hoolibet", "getnextsuperblock", &getnextsuperblock, true, true, false},
        {"hoolibet", "getbudgetprojection", &getbudgetprojection, true, true, false},
        {"hoolibet", "getbudgetinfo", &getbudgetinfo, true, true, false},
        {"hoolibet", "mnbudgetrawvote", &mnbudgetrawvote, true, true, false},
        {"hoolibet", "mnfinalbudget", &mnfinalbudget, true, true, false},
        {"hoolibet", "checkbudgets", &checkbudgets, true, true, false},
        {"hoolibet", "mnsync", &mnsync, true, true, false},
        {"hoolibet", "spork", &spork, true, true, false},
        {"hoolibet", "getpoolinfo", &getpoolinfo, true, true, false},
        ...
        // hbet {"zerocoin", "getzerocoinbalance", &getzerocoinbalance, false, false, true},
        ...
        {"zerocoin", "getzhbetseed", &getzhbetseed, false, false, true},
        {"zerocoin", "setzhbetseed", &setzhbetseed, false, false, true},
        {"zerocoin", "generatemintlist", &generatemintlist, false, false, true},
        {"zerocoin", "searchdzhbet", &searchdzhbet, false, false, true},
        {"zerocoin", "dzhbetstate", &dzhbetstate, false, false, true}
...
{
    return "> hoolibet-cli " + methodname + " " + args + "\n";
}
...
std::string HelpExampleRpc(string methodname, string args)
{
    return "> curl --user myusername --data-binary '{\"jsonrpc\": \"1.0\", \"id\":\"curltest\", "
           "\"method\": \"" +
           methodname + "\", \"params\": [" + args + "] }' -H 'content-type: text/plain;' http://127.0.0.1:21341/\n";
}
