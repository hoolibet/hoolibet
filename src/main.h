...
inline int64_t GetMNCollateral(int nHeight) {
	...
	if (nHeight < 41500) {
		return 1000;
	} else if (nHeight >= 41500 && nHeight < 75000) {
		return 2000;
	} else if (nHeight >= 75000 && nHeight < 120000) {
		return 4000;
	} else if (nHeight >= 120000 && nHeight < 210000) {
		return 5000;
...
inline int64_t GetMNCollateralOld(int nHeight) {
	...
	if (nHeight < 42000) {
		return 1000;
	} else if (nHeight >= 42000 && nHeight < 75500) {
		return 2000;
	} else if (nHeight >= 75500 && nHeight < 120500) {
		return 4000;
	} else if (nHeight >= 120500 && nHeight < 210500) {
		return 5000;
	} else if (nHeight >= 210500) {
		return 10000;
	}
}
...
CAmount StakeInputMinimal(int nHeight);
