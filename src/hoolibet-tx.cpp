...
static bool AppInitRawTx(int argc, char* argv[])
{
    ...
    if (argc < 2 || mapArgs.count("-?") || mapArgs.count("-help")) {
        ...
        std::string strUsage = _("HooliBet Core hoolibet-tx utility version") + " " + FormatFullVersion() + "\n\n" +
                               _("Usage:") + "\n" +
                               "  hoolibet-tx [options] <hex-tx> [commands]  " + _("Update hex-encoded hoolibet transaction") + "\n" +
                               "  hoolibet-tx [options] -create [commands]   " + _("Create hex-encoded hoolibet transaction") + "\n" +
                               "\n";
...
static int CommandLineRawTx(int argc, char* argv[])
{
    ...
    try {
        ...
        if (!fCreateBlank) {
            ...
            // param: hex-encoded hoolibet transaction
