...
/**
 * HooliBet RPC command dispatcher.
 */
class CRPCTable
{
private:
...
// hbet extern UniValue getzerocoinbalance(const UniValue& params, bool fHelp);
...
extern UniValue setzhbetseed(const UniValue& params, bool fHelp);
extern UniValue getzhbetseed(const UniValue& params, bool fHelp);
extern UniValue generatemintlist(const UniValue& params, bool fHelp);
extern UniValue searchdzhbet(const UniValue& params, bool fHelp);
extern UniValue dzhbetstate(const UniValue& params, bool fHelp);
