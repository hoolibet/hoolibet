...
/** Utility functions used by the HooliBet Qt UI.
 */
namespace GUIUtil
{
...
// Render HooliBet addresses in monospace font
...
// Parse "hoolibet:" URI into recipient object, return true on successful parsing
