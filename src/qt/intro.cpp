...
bool Intro::pickDataDirectory()
{
    ...
    if (!fs::exists(GUIUtil::qstringToBoostPath(dataDir)) || GetBoolArg("-choosedatadir", false)) {
        ...
        while (true) {
            ...
            try {
                ...
                QMessageBox::critical(0, tr("HooliBet Core"),
     ...
     * override -datadir in the hoolibet.conf file in the default data directory
     * (to be consistent with hoolibetd behavior)
     */
    if (dataDir != getDefaultDataDirectory())
