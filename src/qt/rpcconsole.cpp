                                          ...
                                          banTableContextMenu(0)
{
    ...
    std::string strzHBETPathCustom = GetArg("-zhbetbackuppath", "");
    ...
    if(!strzHBETPathCustom.empty()) {
        ui->wallet_customzhbetbackuppath->setText(QString::fromStdString(strzHBETPathCustom));
        ui->wallet_customzhbetbackuppath_label->setVisible(true);
        ui->wallet_customzhbetbackuppath->setVisible(true);
    }

    if((!strPathCustom.empty() || !strzHBETPathCustom.empty()) && nCustomBackupThreshold > 0) {
...
void RPCConsole::clear()
{
    ...
    message(CMD_REPLY, (tr("Welcome to the HooliBet RPC console.") + "<br>" +
