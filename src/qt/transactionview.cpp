 ...
 */
    ...
    typeWidget->addItem(tr("Minted"), TransactionFilterProxy::TYPE(TransactionRecord::StakeMint) | TransactionFilterProxy::TYPE(TransactionRecord::StakeZHBET));
    typeWidget->addItem(tr("Masternode Reward"), TransactionFilterProxy::TYPE(TransactionRecord::MNReward));
    // hbet typeWidget->addItem(tr("Received HBET from zHBET"), TransactionFilterProxy::TYPE(TransactionRecord::RecvFromZerocoinSpend));
    // hbet typeWidget->addItem(tr("Zerocoin Mint"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinMint));
    // hbet typeWidget->addItem(tr("Zerocoin Spend"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend));
    // hbet typeWidget->addItem(tr("Zerocoin Spend, Change in zHBET"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_Change_zHbet));
    // hbet typeWidget->addItem(tr("Zerocoin Spend to Self"), TransactionFilterProxy::TYPE(TransactionRecord::ZerocoinSpend_FromMe));
