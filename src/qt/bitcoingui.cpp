                                                                            ...
                                                                            spinnerFrame(0)
{
    ...
    QString windowTitle = tr("HooliBet Core") + " - ";
#ifdef ENABLE_WALLET
...
void BitcoinGUI::createActions(const NetworkStyle* networkStyle)
{
    ...
    sendCoinsAction->setStatusTip(tr("Send coins to a HooliBet address"));
    ...
    receiveCoinsAction->setStatusTip(tr("Request payments (generates QR codes and hoolibet: URIs)"));
    ...
    privacyAction->setStatusTip(tr("Privacy Actions for zHBET"));
    ...
    aboutAction = new QAction(networkStyle->getAppIcon(), tr("&About HooliBet Core"), this);
    aboutAction->setStatusTip(tr("Show information about HooliBet Core"));
    ...
    optionsAction->setStatusTip(tr("Modify configuration options for HooliBet"));
    ...
    signMessageAction->setStatusTip(tr("Sign messages with your HooliBet addresses to prove you own them"));
    verifyMessageAction = new QAction(QIcon(":/icons/transaction_0"), tr("&Verify message..."), this);
    verifyMessageAction->setStatusTip(tr("Verify messages to ensure they were signed with specified HooliBet addresses"));
    ...
    openAction->setStatusTip(tr("Open a HooliBet: URI or payment request"));
    openBlockExplorerAction = new QAction(QIcon(":/icons/explorer"), tr("&Blockchain explorer"), this);
    openBlockExplorerAction->setStatusTip(tr("Block explorer window"));

    showHelpMessageAction = new QAction(QApplication::style()->standardIcon(QStyle::SP_MessageBoxInformation), tr("&Command-line options"), this);
    showHelpMessageAction->setMenuRole(QAction::NoRole);
    showHelpMessageAction->setStatusTip(tr("Show the HooliBet Core help message to get a list with possible HooliBet command-line options"));
...
void BitcoinGUI::createTrayIcon(const NetworkStyle* networkStyle)
{
    ...
    QString toolTip = tr("HooliBet Core client") + " " + networkStyle->getTitleAddText();
...
void BitcoinGUI::setNumConnections(int count)
{
    ...
    labelConnectionsIcon->setToolTip(tr("%n active connection(s) to HooliBet network", "", count));
}
...
{
    QString strTitle = tr("HooliBet Core"); // default title
