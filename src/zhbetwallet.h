...
#ifndef HOOLIBET_ZHBETWALLET_H
#define HOOLIBET_ZHBETWALLET_H
...
public:
    CzHBETWallet(std::string strWalletFile);
    ...
    void GenerateDeterministicZHBET(libzerocoin::CoinDenomination denom, libzerocoin::PrivateCoin& coin, CDeterministicMint& dMint, bool fGenerateOnly = false);
    ...
    void UpdateCount();
    void Lock();
    void SeedToZHBET(const uint512& seed, CBigNum& bnValue, CBigNum& bnSerial, CBigNum& bnRandomness, CKey& key);

private:
    uint512 GetZerocoinSeed(uint32_t n);
};

#endif //HOOLIBET_ZHBETWALLET_H
